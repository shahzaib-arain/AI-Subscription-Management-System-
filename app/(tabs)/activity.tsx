...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 24, fontWeight: "bold", color: "#fcfcfc", marginBottom: 24, fontFamily: "Manrope_800ExtraBold" },
  list: { gap: 12 },
  ...
  itemTitle: { color: "#fcfcfc", fontSize: 14, fontWeight: "500", marginBottom: 2, fontFamily: "Manrope_600SemiBold" },
  itemDate: { color: "#7e828d", fontSize: 12, fontFamily: "Manrope_400Regular" },
  amount: { color: "#fcfcfc", fontSize: 14, fontWeight: "bold", fontFamily: "Manrope_700Bold" }
});
