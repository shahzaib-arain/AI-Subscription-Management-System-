...
export default function EditCardPage() {
  ...
  const getValue = (key: FocusedField) => {
    if (key === "number") {
      // Format with spaces for better display/autofill compatibility
          ...
          <View style={styles.fieldBlock}>
            ...
            <View style={styles.inputRow}>
              ...
              <TextInput
                ...
                onFocus={() => {
                  setTimeout(() => setFocused("number"), 50);
                }}
                onBlur={() => {}}
            ...
            <View style={[styles.fieldBlock, { flex: 1 }]}>
              ...
              <View style={styles.inputRow}>
                ...
                <TextInput
                  ...
                  onFocus={() => {
                    setTimeout(() => setFocused("expiry"), 50);
                  }}
                  onBlur={() => {}}
                  keyboardType="numeric"
                  maxLength={5}
...
const styles = StyleSheet.create({
  ...
  scroll: { paddingHorizontal: 22, paddingTop: 0, paddingBottom: 48 },
  ...
  inputRowFocused: {
    borderColor: "#14ed9e",
    shadowColor: "#14ed9e", shadowOpacity: 0.12, shadowRadius: 8, 
