...
const styles = StyleSheet.create({
  ...
  subTitle: { color: "#fcfcfc", fontSize: 24, fontWeight: "bold", marginBottom: 4 },
  subCategory: { color: "#7e828d", fontSize: 14, marginBottom: 8 },
  amountRow: { flexDirection: "row", alignItems: "flex-end", gap: 4, marginBottom: 12 },
  amountText: { color: "#14ed9e", fontSize: 32, fontWeight: "bold" },
  cycleText: { color: "#7e828d", fontSize: 12, marginBottom: 6 },
  badge: { paddingHorizontal: 12, paddingVertical: 4, borderRadius: 12 },
  badgeText: { fontSize: 12, fontWeight: "600" },
  
  infoCard: { backgroundColor: "rgba(35, 36, 47, 0.6)", borderRadius: 16, padding: 16, marginBottom: 24 },
  infoRow: { flexDirection: "row", justifyContent: "space-between", alignItems: "center" },
  infoLabel: { color: "#7e828d", fontSize: 14 },
  infoValue: { color: "#fcfcfc", fontSize: 14, fontWeight: "500", textTransform: "capitalize" },
  ...
  actionText: { color: "#7e828d", fontSize: 11, fontWeight: "500" },
  
  historyTitle: { color: "#fcfcfc", fontSize: 14, fontWeight: "600", marginBottom: 12 },
  ...
  historyDate: { color: "#7e828d", fontSize: 14 },
  historyAmount: { color: "#fcfcfc", fontSize: 14, fontWeight: "500" }
});
