      ...
      <View style={styles.formContainer}>
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.subtitle}>
            {token
              ? "Enter a new password to complete resetting your account."
              : "This reset link appears invalid or expired. Request a new password reset link."}
          </Text>
        </View>
        ...
        {!token ? (
          <View style={styles.noticeBox}>
            <Text style={styles.noticeText}>
              No reset token was found. Please go back to forgot password and request a new link.
            </Text>
            <Link href="/auth/forgot-password" asChild>
              <TouchableOpacity style={styles.linkButton}>
                <Text style={styles.linkButtonText}>Request new reset link</Text>
              </TouchableOpacity>
            </Link>
          </View>
        ) : (
